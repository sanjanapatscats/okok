...
export default ({ isTopRated = true, gig, proposalsAll = [] }) => {
  ...
  return (
    <div
      className="border border-white border-opacity-25 bg-gradient-to-br from-red-900 via-gray-700 to-gray-950 shadow-md rounded-lg backdrop-blur-lg overflow-hidden transition-all duration-500"
